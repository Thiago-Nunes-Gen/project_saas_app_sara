-- ========================================
-- FIX: Adicionar etapa de EMAIL no onboarding
-- ========================================
-- PROBLEMA: Onboarding estava pulando a mensagem de planos
-- CAUSA: salvar_cidade ia direto para 'plans', mas n8n esperava 'email'
-- SOLUÇÃO: Adicionar ação 'salvar_email' e ajustar fluxo
-- ========================================
...
BEGIN
  ...
  IF p_acao = 'salvar_email' THEN
    ...
    IF p_valor IS NULL OR trim(p_valor) = '' THEN
      RETURN jsonb_build_object('status', 'erro', 'msg', 'Email não informado');
    END IF;
